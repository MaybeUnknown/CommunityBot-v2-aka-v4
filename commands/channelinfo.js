module.exports.run = async (client, message, args) => {
  ...
  if(message.channel.type === "dm") return message.channel.send(string.channelinfoError);
    ...
    message.channel.send(new RichEmbed().setTitle(string.chinfoTitle + message.channel.name).setColor("RANDOM")
  ...
  module.exports.help = {
      name: "channelinfo",
      category: "Użytkownik",
      description: `Informacje o podanym kanale 
      {prefix}channelinfo <wzmianka kanału>`,
      aliases: [],
